...
public class findSta extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==button) {
			if(sDaoImpl.finSta(staff)) {
				List list = sDaoImpl.findStaInfor(staff);
				...
				JOptionPane.showMessageDialog(textField, "没有此记录（请检查你的输入）","查询失败",JOptionPane.WARNING_MESSAGE);
			}
		}
	}
}
